...
console.log("Installation Wellness 5.3 - iPhone, pas modifiables et liquides...\n");
...
pkg.version = "5.3.0";
pkg.description = "Wellness 5.3 - iPhone compatibility, editable steps and liquid volume units";
...
index = index.replace(/Wellness 5\.2\.1/g, "Wellness 5.3.0");
index = index.replace(
...
hardening = hardening.replace(/const APP_VERSION = "[^"]+";/, 'const APP_VERSION = "5.3.0";');
write("hardening-core.js", hardening);

let w2 = read("wellness2.js");
w2 = w2.replace(/const W2_VERSION = "[^"]+";/, 'const W2_VERSION = "5.3.0";');
write("wellness2.js", w2);

let sw = read("sw.js");
sw = sw.replace(/const CACHE = "wellness-[^"]+";/, 'const CACHE = "wellness-5.3.0";');
sw = replaceRequired(
  sw,
  '  "./final-v52.js",',
  '  "./final-v52.js",\n  "./viewport-v53.js",\n  "./ux-v53-core.js",\n  "./ux-v53.js",',
...
ota = ota.replace(/VERSION="5\.2\.1-\$\{GITHUB_SHA::12\}"/g, 'VERSION="5.3.0-${GITHUB_SHA::12}"');
ota = ota.replace(/"appVersion": "5\.2\.1"/g, '"appVersion": "5.3.0"');
